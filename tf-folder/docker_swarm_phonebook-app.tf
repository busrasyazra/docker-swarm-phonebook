...
locals {
  github-repo = "https://github.com/busrasyazra/docker-swarm-phonebook.git"
  github-file-url = "https://raw.githubusercontent.com/busrasyazra/docker-swarm-phonebook/master/"
}
